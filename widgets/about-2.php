...
class Xroof_About_Widget_2 extends Widget_Base
{
    use Xroof_Controls_Trait;

    public function get_name()
    {
        return 'xroof-about-2';
    }

    public function get_title()
    {
        return esc_html__('Xroof About 2', 'xroof');
    }
    ...
    protected function register_controls_section()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => xroof_kses('Building Trust — Your <span>Roofing</span> Experts for Life', 'xroof'),
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::TEXTAREA,
                'default' => xroof_kses('With years of experience and a passion for excellence, we provide reliable, high-quality roofing solutions that stand the test of time. Our skilled team is dedicated to protecting your home or business with expert craftsmanship', 'xroof'),
        ...
        $this->start_controls_section(
            'about_solutions_section',
            [
                'label' => esc_html__('Solutions', 'xroof'),
                'tab' => Controls_Manager::TAB_CONTENT,
            ]
        );
        ...
        $repeater->add_control(
            'about_solution_text',
            [
                'label' => esc_html__('Feature Title', 'xroof'),
                'type' => Controls_Manager::TEXTAREA,
                'default' => esc_html__('Type your text', 'xroof'),
                'label_block' => true,
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'default' => [
                    [
                        'about_solution_text' => 'Solution for Residential Roofing',
                    ],
                    [
                        'about_solution_text' => 'Solution for Commercial Roofing',
                    ],
                ],
                'title_field' => '{{{ about_solution_text }}}',
            ]
        );
        $this->end_controls_section();
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Features', 'xroof'),
                'tab' => Controls_Manager::TAB_CONTENT,
            ]
        );
        $repeater = new Repeater();
        $repeater->add_control(
            ...
            [
                ...
                'default' => esc_html__('Type your feature title', 'xroof'),
                'label_block' => true,
            ]
        );
        $repeater->add_control(
            'about_feature_text',
            [
                'label' => esc_html__('Feature Text', 'xroof'),
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__('Type your feature text', 'xroof'),
                'label_block' => true,
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'default' => [
                    [
                        'about_feature_title' => 'Affordable Price',
                        'about_feature_text' => 'We believe top-quality roofing shouldn’t come with.'
                    ],
                    [
                        'about_feature_title' => '100% Guarantee',
                        'about_feature_text' => 'Your peace of mind is our top priority which is why we stand.'
                    ],
                    [
                        'about_feature_title' => '24/7 Our Services',
                        'about_feature_text' => 'Our expert team is available 24/7 to handle urgent repairs.'
                    ],
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::TEXTAREA,
                'default' => esc_html__('Satisfied Customers', 'xroof'),
        ...
        $this->add_control(
            ...
            [
                ...
                'placeholder' => esc_html__('Type your suffix', 'xroof'),
            ]
        );
        $this->end_controls_section();
    }
    ...
    {
        $this->start_controls_section(
            'about_content_style_section',
            [
                'label' => esc_html__('Content Style', 'xroof'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        $this->register_text_style_controls('about_title', 'about__title', 'Title');
        $this->add_control(
            'about_title_highlight',
            [
                'label' => esc_html__('Title Highlight Color', 'xroof'),
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .about__title span' => 'color: {{VALUE}}',
                ],
            ]
        );
        $this->register_text_style_controls('about_desc', 'about__desc', 'Description');
        $this->add_section_heading('about_image', 'About Image');
        $this->register_border_radius_control('about_image_border_radius', 'about__image');
        $this->end_controls_section();

        $this->start_controls_section(
            'about_solution_style_section',
            [
                'label' => esc_html__('Solution Style', 'xroof'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        $this->add_control(
            'about_solutions',
            [
                'label' => esc_html__('Solutions Background', 'xroof'),
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .about__solutions' => 'background: {{VALUE}}',
                ],
            ]
        );
        $this->register_border_radius_control('about_solutions_border_radius', 'about__solutions');
        $this->register_text_style_controls('solution_text', 'about__solution-text', 'Text');
        $this->end_controls_section();

        $this->start_controls_section(
            'about_features_style_section',
            [
                'label' => esc_html__('Features Style', 'xroof'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        $this->register_text_style_controls('feature_title', 'about__feature-title', 'Title');
        $this->register_text_style_controls('feature_text', 'about__feature-text', 'Text');
        $this->add_section_heading('feature_icon_heading', 'Feature Icon');
        $this->add_size_controls('stat_icon', 'stat__icon svg', ['px', '%'], 500);
        $this->add_control(
            'feature_icon',
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .about__feature-icon svg path' => 'fill: {{VALUE}}',
                ],
            ]
        );
        $this->end_controls_section();
        ...
        $this->start_controls_section(
            'about_stats_style_section',
            [
                'label' => esc_html__('Stats Style', 'xroof'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        $this->add_control(
            'text_color',
            [
                'label' => esc_html__('Stats Background', 'xroof'),
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .about__stat' => 'background: {{VALUE}}',
                ],
            ]
        );
        $this->register_text_style_controls('stat_number', 'about__stat-number', 'Number');
        $this->register_text_style_controls('stat_text', 'about__stat-text', 'Number');
        $this->add_control(
            'stat_icon_color',
            [
                'label' => esc_html__('Icon Color', 'xroof'),
        ...
        $this->add_size_controls('stat_icon_size', 'stat__icon svg', ['px', '%'], 500);
        $this->end_controls_section();
    }
    ...
    protected function render()
    {
        ...
        $feature_item_count = count($features);

        $feature_col = 'col-12 col-sm-6 col-xl-4';
        if ($feature_item_count === 1) {
            $feature_col = 'col-12';
        } elseif ($feature_item_count === 2) {
            $feature_col = 'col-12 col-sm-6';
        } elseif ($feature_item_count === 3) {
            $feature_col = 'col-12 col-sm-6 col-xl-4';
        } elseif ($feature_item_count === 4) {
            $feature_col = 'col-12 col-sm-6 col-xl-3';
        } else {
            $feature_col = 'col-12 col-sm-6 col-xl-2';
        }

        ?>

        <section class="about about--style-2">
            <div class="about__container container">
                <div class="row align-items-center g-5">
                    <div class="col-lg-12 col-xl-6">
                        <div class="about__content">
                            <?php if (!empty($settings['about_title'])): ?>
                                <h2 class="about__title title-xl mb-6"><?php echo xroof_kses($settings['about_title']) ?></h2>
                            <?php endif; ?>

                            <?php if (!empty($settings['about_desc'])): ?>
                                <p class="about__desc body-text"><?php echo xroof_kses($settings['about_desc']) ?></p>
                            <?php endif; ?>

                            <?php if (!empty($settings['solutions_list'])): ?>
                                <ul class="about__solutions list--check d-flex flex-column gap-4 mt-8">
                                    <?php foreach ($settings['solutions_list'] as $key => $item) { ?>
                                        <li class="about__solution-text"><?php echo esc_html($item['about_solution_text']); ?></li>
                                    <?php } ?>
                                </ul>
                            <?php endif; ?>

                            <?php if (!empty($feature_item_count)): ?>
                                <div class="about__features row g-5 mt-8 py-6">
                                    <?php foreach ($features as $item): ?>
                                        <div class="<?php echo esc_attr($feature_col); ?>">
                                            <div class="about__feature text-center py-6">
                                                <div class="about__feature-icon mb-4">
                                                    <svg width="29" height="17" viewBox="0 0 29 17" fill="none">
                                                        <path
                                                            d="M20.886 15.502L14.9912 10.0282V3.01792L20.886 8.49167V15.502ZM14.0088 10.0282L8.11404 15.502V8.49167L14.0088 3.01792V10.0282ZM14.5 10.9124L20.1265 16.1371H18.6332L14.8473 12.3512C14.7552 12.2592 14.6303 12.2074 14.5 12.2074C14.3697 12.2074 14.2448 12.2592 14.1527 12.3512L10.3668 16.1371H8.87347L14.5 10.9124ZM17.244 16.1371H11.756L14.5 13.3931L17.244 16.1371ZM0.5 11.2249L5.00309 0.417847H23.9969L28.5 11.2249H21.8684V8.2775C21.8685 8.20993 21.8546 8.14308 21.8276 8.08112C21.8007 8.01917 21.7612 7.96344 21.7117 7.91743L14.8345 1.53146C14.7436 1.44694 14.6241 1.39995 14.5 1.39995C14.3759 1.39995 14.2564 1.44694 14.1655 1.53146L7.28828 7.91743C7.2388 7.96344 7.19935 8.01917 7.17238 8.08112C7.14542 8.14308 7.13153 8.20993 7.13158 8.2775V11.2249H0.5Z"
                                                            fill="#EE212B" />
                                                    </svg>
                                                </div>

                                                <?php if (!empty($item['about_feature_title'])): ?>
                                                    <h4 class="about__feature-title card-title mb-6">
                                                        <?php echo esc_html($item['about_feature_title']); ?>
                                                    </h4>
                                                <?php endif; ?>

                                                <?php if (!empty($item['about_feature_text'])): ?>
                                                    <p class="about__feature-text body-text">
                                                        <?php echo esc_html($item['about_feature_text']); ?>
                                                    </p>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                    ...
                    <div class="col-lg-12 col-xl-6">
                        <div class="about__image position-relative mt-lg-10 mt-xl-0">
                            <?php if (!empty($settings['about_image'])): ?>
                                <img src="<?php echo esc_url($settings['about_image']['url']); ?>" alt="About Us"
                            ...
                            <div class="about__stat p-4 py-xl-4 px-xl-7">
                                <div
                                    ...
                                    <?php if (!empty($settings['about_stat_number'])): ?>
                                        <h3 class="about__stat-number title-xl-white mb-0" stat-data-start="0" stat-data-end="99"
                                            data-duration="1000" data-format="full"
                                            data-suffix="<?php echo esc_attr($settings['about_stat_suffix']) ?>">
                                            <?php echo esc_html($settings['about_stat_number']); ?>
                                        </h3>
                                    <?php endif ?>
                                ...
                                <?php if (!empty($settings['about_stat_text'])): ?>
                                    <span class="about__stat-text"><?php echo esc_html($settings['about_stat_text']) ?></span>
                                <?php endif ?>
                            </div>
                        </div>
                    </div>
...
$widgets_manager->register(new Xroof_About_Widget_2());
