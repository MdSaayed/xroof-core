<?php
/**
 * Plugin Name: Xroof Core
 * Description: Core plugin for Xroof theme, providing custom Elementor widgets and functionality.
 * Plugin URI:  
 * Version:     1.0.0
 * Author:      Kitdokan
 * Author URI: https://themeforest.net/user/kitdokan
 * Text Domain: xroof-core
