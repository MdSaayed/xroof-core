...
class Xroof_Services_Widget extends \Elementor\Widget_Base
{
    use Xroof_Controls_Trait;

    public function get_name()
    {
        return 'xroof_services';
    }

    public function get_title()
    {
        return esc_html__('Xroof Services', 'xroof');
    }
    ...
    protected function register_style_section()
    {
        ...
        $this->add_universal_input_control('services-top-heading', 'Services Top Background', 'heading');
    ...
    protected function render()
    {
        ...
        <section class="services services--style-1">
            <div class="services__top pb-20">
                <div class="services__top-container container">
                    <?php $this->render_subtitle('services-top-subtitle', 'services__top-subtitle'); ?>

                    <?php if (!empty($settings['title'])): ?>
                        <h2 class="services__top-title title-xl-white"><?php echo esc_html($settings['title']); ?></h2>
                    <?php endif; ?>

                    <?php if (!empty($settings['description'])): ?>
                        <p class="services__top-desc body-text mb-20"><?php echo esc_html($settings['description']); ?></p>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <?php if (!empty($settings['services_cards'])): ?>
                <div class="services__bottom">
                    <div class="service__bottom-container container">
...
$widgets_manager->register(new Xroof_Services_Widget());
