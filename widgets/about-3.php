...
class Xroof_About_Widget_3 extends Widget_Base
{
    use Xroof_Controls_Trait;

    public function get_name()
    {
        return 'xroof-about-3';
    }

    public function get_title()
    {
        return esc_html__('Xroof About 3', 'xroof');
    }
    ...
    protected function register_content_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => esc_html__('About Our Company', 'xroof'),
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::TEXTAREA,
                'default' => esc_html__('Your Trusted Roofing Partner — Quality, Integrity', 'xroof'),
            ]
        );
        $this->add_control(
            'about_desc',
            [
                ...
                'type' => \Elementor\Controls_Manager::TEXTAREA,
                'default' => esc_html__('At XRooF we’re more than just roofers — we’re dedicated professionals committed to protecting your home or business with exceptional craftsmanship. With years of hands-on experience and a reputation for honesty, we combine premium', 'xroof', 'xroof'),
                'placeholder' => esc_html__('Enter your description here'),
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Solution List', 'xroof'),
                'tab' => Controls_Manager::TAB_CONTENT,
            ]
        );
        ...
        $repeater->add_control(
            'solution_text',
            [
                'label' => esc_html__('Solution Text', 'xroof'),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => esc_html__('Enter Your Text', 'xroof'),
                'label_block' => true,
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'default' => [
                    [
                        'solution_text' => esc_html__('Request & Scheduling', 'xroof'),
                    ],
                    [
                        'solution_text' => esc_html__('On-Site Evaluation & Estimate', 'xroof'),
                    ],
                    [
                        'solution_text' => esc_html__('Quality Service by Professionals', 'xroof'),
                    ],
                    [
                        'solution_text' => esc_html__('Expert Service & Follow-Up', 'xroof'),
                    ]
                ],
                'title_field' => '{{{ solution_text }}}',
            ]
        );
        $this->end_controls_section();
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::TEXTAREA,
                'default' => esc_html__('Happy clients all over world now.', 'xroof'),
            ]
        );
        $this->add_control(
            'stat_avatar',
            [
                'label' => esc_html__('Add Avatar', 'xroof'),
                'type' => \Elementor\Controls_Manager::GALLERY,
                'show_label' => false,
                'description' => esc_html__('Recommended image size: 48px × 48px for best visual quality.', 'xroof'),
                'default' => [
                    [
                        'id' => 0,
        ...
        $this->start_controls_section(
            'about_button_section',
            [
                'label' => esc_html__('Buttons', 'xroof'),
                'tab' => Controls_Manager::TAB_CONTENT,
            ]
        );
        $this->register_button_content_controls('about_btn', 'about__btn', 'Button 01');
        $this->register_button_content_controls('about_btn_phn', 'about__btn-info', 'Button 02');
        $this->add_control(
            'btn_info_text',
            [
                'label' => esc_html__('Info Text', 'xroof'),
                'type' => \Elementor\Controls_Manager::TEXTAREA,
                'default' => esc_html__('Call us any time', 'xroof'),
            ]
        );
        $this->add_control(
            'btn_info_number',
            [
                ...
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => esc_html__('+(234) 567-8912', 'xroof'),
            ]
        );
        $this->end_controls_section();

        $this->start_controls_section(
            'about_image_and_text_section',
            [
                'label' => esc_html__('Image and BG Text', 'xroof'),
                'tab' => Controls_Manager::TAB_CONTENT,
            ]
        );
        $this->add_control(
            'about_image_1',
            [
                'label' => esc_html__('Choose Image 1', 'xroof'),
        ...
        $this->add_control(
            'about_image_2',
            [
                'label' => esc_html__('Choose Image 2', 'xroof'),
                'type' => \Elementor\Controls_Manager::MEDIA,
                'description' => esc_html__('Recommended image dimensions: 410px × 300px.', 'xroof'),
                'default' => [
        ...
        $this->add_control(
            'about_bg_text',
            [
                'label' => esc_html__('Background Text', 'xroof'),
                'type' => \Elementor\Controls_Manager::TEXTAREA,
                'default' => esc_html__('2025', 'xroof'),
            ]
        );
        $this->end_controls_section();
    }
    ...
    protected function register_style_controls()
    {
        ...
        $this->register_text_style_controls('about_subtitle', 'about_subtitle', 'Subtitle');
        $this->register_text_style_controls('about_title', 'about_title', 'Title');
        $this->register_text_style_controls('about_desc', 'about_desc', 'Description');
        $this->end_controls_section();
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .about__solution' => 'color: {{VALUE}}',
                ],
            ]
        );
        $this->end_controls_section();
        ...
        $this->add_control(
            'about_stat_number_color',
            [
                'label' => esc_html__('Number Color', 'xroof'),
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .about__stat-number' => 'color: {{VALUE}}',
                ],
            ]
        );
        $this->add_control(
            'about_stat_text_color',
            [
                'label' => esc_html__('Text Color', 'xroof'),
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .about__stat-text' => 'color: {{VALUE}}',
                ],
            ]
        );
        $this->add_control(
            'about_stat_icon_color',
            [
                'label' => esc_html__('Icon Color', 'xroof'),
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .about__stat svg path' => 'fill: {{VALUE}}',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->register_text_style_controls('btn_info_text', 'btn__info-text', 'Info Text');
        $this->register_text_style_controls('btn_info_number', 'btn__info-number', 'Number');
        $this->end_controls_section();

        $this->start_controls_section(
            'about_image_style_section',
            [
                'label' => esc_html__('Image & BG Text', 'xroof'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        $this->register_border_radius_control('about_image', 'about__img');
        $this->register_text_style_controls('year_text', 'year__text', 'Year Text');
        $this->end_controls_section();
    }
    ...
    protected function render()
    {
        ...
        <section id="about-3" class="about about--style-3">
            <div class="about__container container">
                <div class="row g-5">
                    <div class="col-12 col-xl-7">
                        <div class="about__left">
                            <?php if (!empty($settings['about_subtitle'])): ?>
                                <p class="about__subtitle subtitle"><?php echo esc_html($settings['about_subtitle']); ?></p>
                            <?php endif; ?>
                            ...
                            <?php if (!empty($settings['about_desc'])): ?>
                                <p class="about__desc mt-4 mt-md-8"><?php echo esc_html($settings['about_desc']); ?></p>
                            <?php endif; ?>

                            <div class="about__left-middle d-flex align-items-center gap-4 mt-8">
                                <?php if (!empty($settings['solution_list'])): ?>
                                    <ul class="about__solutions list--check d-flex flex-column gap-4">
                                        <?php foreach ($settings['solution_list'] as $key => $item): ?>
                                            <li class="about__solution"><?php echo esc_html($item['solution_text']); ?></li>
                                        <?php endforeach; ?>
                                    </ul>
                                <?php endif; ?>

                                <?php if (!empty($settings['about_stat_number'] || !empty($settings['about_stat_text']))): ?>
                                    <div class="about__stat p-4 p-xl-8">
                                        <div
                                        ...
                                        <?php if (!empty($settings['about_stat_text'])): ?>
                                            <p class="about__stat-text mt-2 mb-6 mb-xl-8">
                                                <?php echo esc_html($settings['about_stat_text']); ?>
                                            </p>
                                        <?php endif; ?>

                                        <?php if (!empty($settings['stat_avatar'])): ?>
                                            <div class="about__review-avatars d-flex align-items-center">
                                                <?php foreach ($settings['stat_avatar'] as $key => $item): ?>
                                                    <?php if (!empty($item['url'])): ?>
                                                        <div class="about__avatar-wrap">
                                                            <img src="<?php echo esc_url($item['url']); ?>"
                                                                alt="<?php echo esc_attr__('Customer Avatar', 'xroof'); ?>"
                                                                class="about__avatar" width="48" height="48">
                                                        </div>
                                                    <?php endif; ?>
                                                <?php endforeach; ?>
                                            </div>
                            ...
                            <div class="about__btn-wrap d-flex flex-wrap gap-5 mt-10 mt-xl-20">
                                <?php $this->render_button('about_btn', 'about__btn') ?>

                                <div class="about__btn-wrap flex-items-center flex-wrap gap-4">
                                    <?php $this->render_button('about_btn_phn', 'about__btn-info') ?>

                                    <?php if (!empty($settings['btn_info_text'] || !empty($settings['btn_info_number']))): ?>
                                        <div class="about__btn-info-text d-flex flex-column">
                                            <?php if (!empty($settings['btn_info_text'])): ?>
                                                <span class="btn__info-text mb-0">
                                                    <?php echo esc_html($settings['btn_info_text']); ?>
                                                </span>
                                            <?php endif; ?>
                                            <?php if (!empty($settings['btn_info_number'])): ?>
                                                <span class="btn__info-number mb-0">
                                                    <?php echo esc_html($settings['btn_info_number']); ?>
                                                </span>
                                            <?php endif; ?>
                                        </div>
                                    <?php endif; ?>
                    ...
                    <div class="col-12 col-xl-5">
                        <div class="about__right mt-10 mt-xl-0">
                            <?php if (!empty($settings['about_image_1']['url'] || !empty($settings['about_image_2']['url']))): ?>
                                <div class="about__img-wrap d-flex">
                                    <?php if (!empty($settings['about_image_1']['url'])): ?>
                                        <div class="col-12 col-md-6 col-xl-12">
                                            <img src="<?php echo esc_url($settings['about_image_1']['url']); ?>" alt="About Image"
                                                class="about__img">
                                        </div>
                                    <?php endif; ?>
                                    <?php if (!empty($settings['about_image_2']['url'])): ?>
                                        <div class="col-12 col-md-6 col-xl-12">
                                            <img src="<?php echo esc_url($settings['about_image_2']['url']); ?>" alt="About Image"
                                                class="about__img">
                                        </div>
                                    <?php endif; ?>
                                </div>
                            <?php endif; ?>
                            <?php if (!empty($settings['about_bg_text'])): ?>
                                <div class="year__text-wrap">
                                    <h4 class="year__text"><?php echo esc_html($settings['about_bg_text']); ?></h4>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
...
$widgets_manager->register(new Xroof_About_Widget_3());